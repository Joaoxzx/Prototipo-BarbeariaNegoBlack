...
import { ClubCheckout } from '@/components/club-checkout'
  ...
  return (
    <main className="site-background min-h-dvh">
      ...
      <div className="mx-auto max-w-6xl px-3.5 py-7 min-[360px]:px-4 min-[380px]:py-10 sm:py-14 md:px-6 md:py-16 lg:py-20">
        <div className="route-enter-intro mb-6 max-w-2xl sm:mb-10">
          ...
          <p className="mt-4 text-xs font-medium uppercase tracking-widest text-primary sm:mt-6">Clube Mensal</p>
          <h1 className="mt-2 max-w-[20ch] font-display text-3xl font-bold uppercase leading-tight tracking-tight text-balance text-foreground min-[360px]:text-4xl sm:text-5xl">
            Escolha seu cuidado mensal
          </h1>
          <p className="mt-4 max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-base">
            Quatro atendimentos por mês, prioridade na agenda e duas formas simples de pagamento.
          </p>
        </div>
